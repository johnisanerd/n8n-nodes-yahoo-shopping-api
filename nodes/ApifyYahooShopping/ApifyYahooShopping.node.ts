...
import { properties } from './ApifyYahooShopping.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'KXy0nNSMKq2vThBHB' as string;

export const PACKAGE_NAME = 'n8n-nodes-yahoo-shopping-api' as string;
export const CLASS_NAME = 'ApifyYahooShopping' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'yahoo-shopping-app' as string;

export const DISPLAY_NAME = 'Yahoo Shopping' as string;
export const DESCRIPTION =
	'Search Yahoo Shopping for product listings with prices, sellers, and images' as string;

export class ApifyYahooShopping implements INodeType {
